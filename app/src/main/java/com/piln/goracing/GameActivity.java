...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_semafor = (TextView) findViewById(R.id.tv_semafor);
    }

    public void driverCarAction(View view) {
        if (state == 2) {
    ...
    public void timerPC() {
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (state == 2) {
                            iv_pccar.setX(iv_pccar.getX() + 30);
                        }
        ...
        timerGame.scheduleAtFixedRate(timerTask, 0, 1000);
    }
}